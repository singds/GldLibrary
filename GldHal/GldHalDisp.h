...
typedef struct
{
    ...
    /* Questi due parametri sono utilizzati soltanto in modalit� double buffer.
...
/*______________________________________________________________________________
 ...
 Arg: - <x>[in] coordinata del pixel.
        ...
        <clr>[in] colore del pixel. Questo � sempre un uint32_t ARGB8888, dove
            il campo B � il byte meno significativo:
            B = (clr >> 0) & 0xff;
            G = (clr >> 8) & 0xff;
            ...
 Ret: - None.
...
/*______________________________________________________________________________
 ...
 Ret: - La funzione deve restituire -1 se per qualsiasi motivo non riesce a
    portare a termine l'operazione. In questo caso la libreria proceder�
...
/*______________________________________________________________________________
 ...
 Arg: - <mem_p>[in] indirizzo di memoria dell'area. i pixel sono tutti impaccati:
            non c'� offset fra una linea di pixel e la successiva.
        ...
        <x_size>[in] dimensione x dell'area in pixel.
        <y_size>[in] dimensione y dell'area in pixel.
 Ret: - Ci si aspetta che questa funzione vada sempre a buon fine. Non c'� altra
    alternativa :-)
______________________________________________________________________________*/
...
/*______________________________________________________________________________
 ...
 Ret: - Indirizzo di memoria del framebuffer. La libreria scrive all'interno del
    ...
    devono essere impaccati: non � previso offset fra una linea di pixel e la
    successiva.
______________________________________________________________________________*/
...
/*______________________________________________________________________________
 ...
 Ret: - La funzione deve ritornare soltanto quando il framebuffer �
